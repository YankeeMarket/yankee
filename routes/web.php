...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get("/orders", 'WebhookController@view_non_cancelled_orders');
    Route::get("/all_orders", 'WebhookController@view_all_orders');
    ...
    Route::get("/cull", 'DPDController@cull_labels');

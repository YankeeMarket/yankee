...
/**
 * BigCommerce service, based on Dropbox service
 *
 ...
 * @link https://support.bigcommerce.com/articles/Public/Store-API-Accounts
 * @link https://developer.bigcommerce.com/api/
 */

class BigCommerceService extends AbstractService
{
    public function __construct(
        ...
        if (null === $baseApiUri) {
            $this->baseApiUri = new Uri('https://api.bigcommerce.com/stores/2gskm2kkjs/v3/');
        }
    }
